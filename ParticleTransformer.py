...
class ParticleTransformer1(nn.Module):
...
class ParticleTransformer1Tagger(nn.Module):
    ...
    def __init__(self,
        ...
        self.part = ParticleTransformer1(input_dim=embed_dims[-1],
...
class ParticleTransformer1TaggerWithExtraPairFeatures(nn.Module):
